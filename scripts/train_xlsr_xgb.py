...
from src.models.xgboost_classifier import XGBoostBaselineClassifier
from src.preprocessing.audio_preprocessor import AudioPreprocessor

DEFAULT_DB_PATH = PROJECT_ROOT / "data" / "processed" / "metadata.db"
DEFAULT_MODEL_PATH = PROJECT_ROOT / "data" / "processed" / "models" / "xlsr_xgboost.joblib"
...
def run_training_and_evaluation(
    ...
    extractor = XlsrFeatureExtractor()
    classifier = XGBoostBaselineClassifier(random_state=seed, n_estimators=100)
    ...
    print("\n[+] Đang huấn luyện XGBoost Classifier...")
